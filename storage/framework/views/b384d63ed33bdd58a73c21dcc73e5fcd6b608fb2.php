...
<div class="container">
    ...
    <div class="table-responsive">
        <form action="<?php echo e(route('payment.online')); ?>" id="create_form" method="post">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-group">
                ...
                <input class="form-control" id="amount"
                       name="amount" type="number" value="<?php echo e($totalMoney); ?>" readonly/>
            </div>
            <div class="form-group">
...
</html><?php /**PATH C:\Users\Acer\Downloads\web-ban-hang-main\web-ban-hang-main\resources\views/frontend/pages/vnpay/index.blade.php ENDPATH**/ ?>