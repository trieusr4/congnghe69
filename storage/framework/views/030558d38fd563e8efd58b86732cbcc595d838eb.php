    ...
    <div class="container">
        <div class="content">
            <div class="left">
                 ...
                 <a href="<?php echo e(route('get.blog.home')); ?>" title="Tin tức & Mẹo" rel="nofollow">Tin tức & Mẹo</a>
                 <?php if(Auth::check()): ?>
...
<?php /**PATH D:\ADMIN\web_ban_giay_L9\web_ban_giay_L9\resources\views/frontend/components/header.blade.php ENDPATH**/ ?>