            ...
            <div class="list">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="qty_number">
                                            ...
                                            <a href="<?php echo e(route('get.shopping.delete', $key)); ?>" class="js-delete-item btn-action-delete"><i class="fa fa-trash"></i></a>
                                        </div>
                                    </td>
                                    <td>
                ...
                <?php else: ?>
                    ...
                    <div style="text-align: center">
                        <div class="btn btn-purple"><a href="<?php echo e(route('get.product.list')); ?>" style="color: #fff">Tiếp tục mua hàng</a></div>
                    </div>
                <?php endif; ?>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app_master_frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Acer\Downloads\web-ban-hang-main\web-ban-hang-main\resources\views/frontend/pages/shopping/index.blade.php ENDPATH**/ ?>