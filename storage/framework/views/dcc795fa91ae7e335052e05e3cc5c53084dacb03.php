                        ...
                        <div class="col-sm-8">
                            <div class="col-sm-12">
                                <div class="form-group <?php echo e($errors->first('c_name') ? 'has-error' : ''); ?>">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo e($category->c_name); ?>" name="c_name"  placeholder="Name ...">
...
<?php echo $__env->make('layouts.app_master_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ADMIN\web_ban_giay_L9\web_ban_giay_Hapi2hand_Finally\resources\views/admin/category/update.blade.php ENDPATH**/ ?>