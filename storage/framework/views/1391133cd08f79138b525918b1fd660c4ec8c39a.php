                            ...
                            <div class="form-group <?php echo e($errors->first('atb_type_id') ? 'has-error' : ''); ?>">
                                ...
                                <select class="form-control" name="atb_type_id">
                                    <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($type->id); ?>" <?php echo e($attribute->atb_type_id == $type->id ? "selected='selected'"  : ''); ?>><?php echo e($type->t_name); ?></option>
...
<?php echo $__env->make('layouts.app_master_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Acer\Downloads\web-ban-hang\cong-nghe-69\resources\views/admin/attribute/update.blade.php ENDPATH**/ ?>