...
<form role="form" action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="box box-warning">
            ...
            <div class="box-body">
                <div class="form-group "> 
                    ...
                    <input type="text" class="form-control" name="a_name" placeholder="Iphone 5s ...." autocomplete="off" value="<?php echo e($article->a_name ?? old('a_name')); ?>"> 
    ...
    <div class="col-sm-12 clearfix">
        <div class="box-footer text-center"> 
            <a href="<?php echo e(route('admin.article.index')); ?>" class="btn btn-default"><i class="fa fa-arrow-left"></i> Cancel</a> 
            <button type="submit" class="btn btn-success"><i class="fa fa-save"></i> <?php echo e(isset($article) ? "Cập nhật" : "Thêm mới"); ?> </button> </div>
    </div>
</form>
...
<?php /**PATH C:\Users\Acer\Downloads\web-ban-hang\cong-nghe-69\resources\views/admin/article/form.blade.php ENDPATH**/ ?>