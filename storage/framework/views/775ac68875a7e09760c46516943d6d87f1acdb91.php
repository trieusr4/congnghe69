                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" class="form-control" name="sd_sort" value="<?php echo e(old('sd_sort',0)); ?>" placeholder="0">
...
<?php echo $__env->make('layouts.app_master_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Acer\Downloads\web-ban-hang\web-ban-hang\resources\views/admin/slide/create.blade.php ENDPATH**/ ?>