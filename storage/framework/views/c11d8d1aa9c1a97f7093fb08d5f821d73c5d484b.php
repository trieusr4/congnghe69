    ...
    <div class="col-sm-8">
        ...
        <div class="col-sm-12">
            <div class="form-group <?php echo e($errors->first('d_percentage') ? 'has-error' : ''); ?>">
                ...
                min="1" max="100" oninvalid="this.setCustomValidity('Vui lòng nhập phần trắm giảm giá từ 1-100')" oninput="setCustomValidity('')">
...
</form><?php /**PATH D:\ADMIN\web_ban_giay_L9\web_ban_giay_L9\resources\views/admin/discount_code/form.blade.php ENDPATH**/ ?>