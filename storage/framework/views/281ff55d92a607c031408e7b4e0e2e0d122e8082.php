                    ...
                    <div class="right__content">
                        ...
                        <div class="ads">
                            <a href="#" title="Giam giá" target="_blank"><img alt="Hoan tien" style="width: 100%"
                                                                              src="<?php echo e(url('images/banner/banner.jpg')); ?>"></a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app_master_frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Acer\Downloads\web-ban-hang-main\web-ban-hang-main\resources\views/frontend/pages/product_detail/index.blade.php ENDPATH**/ ?>