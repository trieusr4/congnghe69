                ...
                <div class="box-title">
                    <form class="form-inline">
                        ...
                        <select name="sort" class="form-control">
                            <option value="desc" {{ Request::get('sort') == "desc" ? "selected='selected'" : "" }}>Mới nhất</option>
                            <option value="asc" {{ Request::get('sort') == "asc" ? "selected='selected'" : "" }}>Cũ nhất</option>
                            <option value="price_desc" {{ Request::get('sort') == "price_desc" ? "selected='selected'" : "" }}>Giá cao đến thấp</option>
                            <option value="price_asc" {{ Request::get('sort') == "price_asc" ? "selected='selected'" : "" }}>Giá thấp đến cao</option>
                            <option value="quantity_asc" {{ Request::get('sort') == "quantity_asc" ? "selected='selected'" : "" }}>Số lượng thấp đến cao</option>
                            <option value="quantity_desc" {{ Request::get('sort') == "quantity_desc" ? "selected='selected'" : "" }}>Số lượng cao đến thấp</option>
                        </select>
