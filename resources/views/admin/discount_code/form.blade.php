    ...
    <div class="col-sm-8">
        ...
        <div class="col-sm-12">
            <div class="form-group {{ $errors->first('d_number_code') ? 'has-error' : '' }}">
                ...
                <input type="number" class="form-control" name="d_number_code" min="1" placeholder="Số lượt sử dụng..." value="{{ old('d_number_code', isset($discount)? $discount->d_number_code : '') }}">
