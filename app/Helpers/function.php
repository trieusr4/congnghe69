...
function checkHas($id, $attributes) {
    $found = false;

// Duyệt qua mảng $product['attributes']
    foreach ($attributes as $attribute) {
        if (isset($attribute['atb_type_id']) && $attribute['atb_type_id'] == $id) {
            // Nếu tìm thấy, đặt $found thành true và thoát khỏi vòng lặp
            $found = true;
            break;
        }
    }
